...
links.forEach(link=>{link.addEventListener("click",function(e){e.preventDefault();showChapter(this.getAttribute("data-chapter"))});link.addEventListener("keyup",function(e){if(e.key==="Enter"){showChapter(this.getAttribute("data-chapter"))}})})});
